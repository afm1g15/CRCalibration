...
int deltaStudies(const char *config){
  ...
  // Setup histograms
  TH1D *h_muon_length               = new TH1D("h_muon_length","",50,0,12); // Muon length [m]
  TH1D *h_delta_length              = new TH1D("h_delta_length","",50,0,0.2); // Secondary length [m]
  TH1D *h_pfp_numDaughters          = new TH1D("h_pfp_numDaughters","",50,0,50); // Number of primary pfparticle daughters
  TH1D *h_pfp_numDaughters_muL      = new TH1D("h_pfp_numDaughters_muL","",50,0,5); // Number of primary pfparticle daughters
  TH1D *h_pfp_numDauHitsTot         = new TH1D("h_pfp_numDauHitsTot","",50,0,500); // Number of primary pfparticle daughter hits in total for the muon
  TH1D *h_pfp_numDauHits            = new TH1D("h_pfp_numDauHits","",25,0,25); // Number of primary pfparticle daughter hits
  TH1D *h_pfp_numDaughters_thresh   = new TH1D("h_pfp_numDaughters_thresh","",50,0,50); // Number of primary pfparticle daughters
  TH1D *h_pfp_numDauHits_thresh     = new TH1D("h_pfp_numDauHits_thresh","",50,0,50); // Number of primary pfparticle daughter hits
  TH1D *h_hits_muL                  = new TH1D("h_hits_muL","",50,0,0.1); // Number of hits per unit length of the primary muon track
  TH1D *h_secondaries_muL           = new TH1D("h_secondaries_muL","",50,0,5); // Number of secondaries per unit length of the primary muon track [m^{-1}]
  
  TH2D *h_muon_length_E               = new TH2D("h_muon_length_E","",50,0.8,40,50,0,12); // Muon length [m]
  TH2D *h_hits_muL_E                  = new TH2D("h_hits_muL_E","",50,0.8,40,50,0,0.1);
  TH2D *h_hits_E                      = new TH2D("h_hits_E","",50,0.8,40,50,0,100);
  TH2D *h_secondaries_muL_E           = new TH2D("h_secondaries_muL_E","",50,0.8,40,50,0,5);
  TH2D *h_secondaries_E               = new TH2D("h_secondaries_E","",50,0.8,40,50,0,50);
  TH2D *h_pfp_numDaughters_E          = new TH2D("h_pfp_numDaughters_E","",50,0.8,40,50,0,10); // Number of primary pfparticle daughters vs energy
  TH2D *h_pfp_numDau_muL_E            = new TH2D("h_pfp_numDau_muL_E","",50,0.8,40,50,0,5); // Number of primary pfparticle daughters vs energy
  TH2D *h_pfp_numDauHitsTot_E         = new TH2D("h_pfp_numDauHitsTot_E","",50,0.8,40,50,0,500); // Number of primary pfparticle total daughter hits vs energy
  TH2D *h_pfp_numDauHits_E            = new TH2D("h_pfp_numDauHits_E","",50,0.8,40,25,0,25); // Number of primary pfparticle daughter hits vs energy
  TH2D *h_pfp_numDauHits_muL_E        = new TH2D("h_pfp_numDauHits_muL_E","",50,0.8,40,50,0,0.1); // Number of primary pfparticle daughters vs energy
  TH2D *h_pfp_numDaughters_thresh_E   = new TH2D("h_pfp_numDaughters_thresh_E","",50,0.8,40,40,0,40); // Number of primary pfparticle daughters vs energy
  TH2D *h_pfp_numDau_muL_thresh_E     = new TH2D("h_pfp_numDau_muL_thresh_E","",50,0.8,40,50,0,0.01); // Number of primary pfparticle daughters vs energy
  TH2D *h_pfp_numDauHits_thresh_E     = new TH2D("h_pfp_numDauHits_thresh_E","",50,0.8,40,50,0,50); // Number of primary pfparticle daughter hits vs energy
  TH2D *h_pfp_numDauHits_muL_thresh_E = new TH2D("h_pfp_numDauHits_muL_thresh_E","",50,0.8,40,50,0,0.1); // Number of primary pfparticle daughters vs energy
  TH2D *h_corr_dqdx_E                 = new TH2D("h_corr_dqdx_E","",300,0.8,40,50,80,600);
  TH2D *h_dedx_rr_lt30GeV             = new TH2D("h_dedx_rr_lt30GeV","",50,0,15,50,0,7); // dE/dx vs RR in the last 50cm of a track (below 30GeV)
  TH2D *h_dedx_rr_gt30GeV             = new TH2D("h_dedx_rr_gt30GeV","",50,0,15,50,0,7); // dE/dx vs RR in the last 50cm of a track (above 30GeV)
  ...
  for(unsigned int iEvt = 0; iEvt < nEvts; ++iEvt){
    ...
    for(unsigned int iTrk = 0; iTrk < nTrks; ++iTrk){
      ...
      h_muon_length->Fill(primaryLength/100.);
      ...
      primaryHitsPerL = nHitsR/primaryLength;
      ...
      h_muon_length_E->Fill(primaryTrueEnergy,primaryLength/100.);
    } // iTrk
    ...
    for(unsigned int iTrk = 0; iTrk < nTrks; ++iTrk){
      ...
      h_delta_length->Fill(deltaLength/100.);
    } // Tracks
    ...
    h_secondaries_muL->Fill(deltaPerMuonL*100.); // [m^{-1}]
    h_hits_muL_E->Fill(primaryTrueEnergy,hitsPerMuonL);
    h_secondaries_muL_E->Fill(primaryTrueEnergy,deltaPerMuonL*100.);
    ...
    for(unsigned int iPfp = 0; iPfp < nPfps; ++iPfp){
      ...
      h_pfp_numDaughters_muL->Fill(daughtersPerL*100.); // [m^{-1}]
      ...
      h_pfp_numDau_muL_E->Fill(primaryTrueEnergy,daughtersPerL*100.);
      h_pfp_numDauHits_muL_E->Fill(primaryTrueEnergy,daughterHitsPerL*100.);
  ...
  h_pfp_numDaughters_muL->SetLineColor(kViolet-5);
  ...
  SetHistogramStyle2D(h_pfp_numDau_muL_E, "True (generated) #mu energy [GeV]", "N_{Daughters}/L_{#mu} [m^{-1}]", false);
  ...
  SetHistogramStyle2D(h_pfp_numDau_muL_thresh_E, "True (generated) #mu energy [GeV]", "N_{Daughters}/L_{#mu} [m^{-1}]", false);
  ...
  SetHistogramStyle2D(h_pfp_numDauHits_muL_E, "True (generated) #mu energy [GeV]", "N_{DaughterHits}/L_{#mu} [m^{-1}]", false);
