...
namespace calib{
  ...
  void SetUserPalette(){
    const int Number = 4;
    double Red[Number]    = {202/255., 106/255., 110/255., 57/255.}; //, 179/255.
    double Green[Number]  = {227/255., 143/255.,  97/255., 51/255.}; //, 103/255.
    double Blue[Number]   = {214/255., 186/255., 140/255., 79/255.}; //,  55/255.
    double Length[Number] = {0, 0.33, 0.66, 1};
    /*
    double Red[Number]    = {220/255., 155/255.,  89/255., 109/255.,  78/255}; //, 179/255.
    double Green[Number]  = {242/255., 176/255., 131/255.,  96/255.,  66/255}; //, 103/255.
    double Blue[Number]   = {216/255., 167/255., 179/255., 150/255., 112/255}; //,  55/255.
    double Length[Number] = {0, 0.1, 0.5, .9, 1};
