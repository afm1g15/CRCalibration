...
int reconstructedCalibration(const char *config){
  ...
  double nominalMPV   = 1.766; // dE/dx MPV [MeV/cm] for a 8.41 GeV muon in 4.8 mm thickness (both values from truth MPVs) from here: https://lar.bnl.gov/properties/
