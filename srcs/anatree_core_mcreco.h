...
// Fri Jan  7 17:14:07 2022 by ROOT version 6.18/04
// from TTree anatree/analysis tree
// found on file: ../../../files/mcreco_ana_hist.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Short_t         hit_tpc[18312];   //[no_hits_stored]
   Short_t         hit_plane[18312];   //[no_hits_stored]
   Short_t         hit_wire[18312];   //[no_hits_stored]
   Short_t         hit_channel[18312];   //[no_hits_stored]
   Float_t         hit_peakT[18312];   //[no_hits_stored]
   Float_t         hit_charge[18312];   //[no_hits_stored]
   Float_t         hit_ph[18312];   //[no_hits_stored]
   Float_t         hit_startT[18312];   //[no_hits_stored]
   Float_t         hit_endT[18312];   //[no_hits_stored]
   Float_t         hit_rms[18312];   //[no_hits_stored]
   Float_t         hit_trueX[18312];   //[no_hits_stored]
   Float_t         hit_goodnessOfFit[18312];   //[no_hits_stored]
   Short_t         hit_multiplicity[18312];   //[no_hits_stored]
   Short_t         hit_trkid[18312];   //[no_hits_stored]
   Short_t         hit_trkKey[18312];   //[no_hits_stored]
   Short_t         hit_clusterid[18312];   //[no_hits_stored]
   Short_t         hit_clusterKey[18312];   //[no_hits_stored]
   Short_t         hit_spacepointid[18312];   //[no_hits_stored]
   Short_t         hit_spacepointKey[18312];   //[no_hits_stored]
   Float_t         hit_nelec[18312];   //[no_hits_stored]
   Float_t         hit_energy[18312];   //[no_hits_stored]
   Short_t         nnuvtx;
   Float_t         nuvtxx[191];   //[nnuvtx]
   Float_t         nuvtxy[191];   //[nnuvtx]
   Float_t         nuvtxz[191];   //[nnuvtx]
   Short_t         nuvtxpdg[191];   //[nnuvtx]
   Short_t         nclusters;
   Short_t         clusterId[801];   //[nclusters]
   Short_t         clusterView[801];   //[nclusters]
   Float_t         cluster_StartCharge[801];   //[nclusters]
   Float_t         cluster_StartAngle[801];   //[nclusters]
   Float_t         cluster_EndCharge[801];   //[nclusters]
   Float_t         cluster_EndAngle[801];   //[nclusters]
   Float_t         cluster_Integral[801];   //[nclusters]
   Float_t         cluster_IntegralAverage[801];   //[nclusters]
   Float_t         cluster_SummedADC[801];   //[nclusters]
   Float_t         cluster_SummedADCaverage[801];   //[nclusters]
   Float_t         cluster_MultipleHitDensity[801];   //[nclusters]
   Float_t         cluster_Width[801];   //[nclusters]
   Short_t         cluster_NHits[801];   //[nclusters]
   Short_t         cluster_StartWire[801];   //[nclusters]
   Short_t         cluster_StartTick[801];   //[nclusters]
   Short_t         cluster_EndWire[801];   //[nclusters]
   Short_t         cluster_EndTick[801];   //[nclusters]
   Short_t         cluncosmictags_tagger[801];   //[nclusters]
   Float_t         clucosmicscore_tagger[801];   //[nclusters]
   Short_t         clucosmictype_tagger[801];   //[nclusters]
   Char_t          kNTracker;
   ...
   Int_t           pdg[9729];   //[geant_list_size]
   Int_t           status[9729];   //[geant_list_size]
   Float_t         Mass[9729];   //[geant_list_size]
   Float_t         Eng[9729];   //[geant_list_size]
   Float_t         EndE[9729];   //[geant_list_size]
   Float_t         Px[9729];   //[geant_list_size]
   Float_t         Py[9729];   //[geant_list_size]
   Float_t         Pz[9729];   //[geant_list_size]
   Float_t         P[9729];   //[geant_list_size]
   Float_t         StartPointx[9729];   //[geant_list_size]
   Float_t         StartPointy[9729];   //[geant_list_size]
   Float_t         StartPointz[9729];   //[geant_list_size]
   Float_t         StartT[9729];   //[geant_list_size]
   Float_t         EndPointx[9729];   //[geant_list_size]
   Float_t         EndPointy[9729];   //[geant_list_size]
   Float_t         EndPointz[9729];   //[geant_list_size]
   Float_t         EndT[9729];   //[geant_list_size]
   Float_t         theta[9729];   //[geant_list_size]
   Float_t         phi[9729];   //[geant_list_size]
   Float_t         theta_xz[9729];   //[geant_list_size]
   Float_t         theta_yz[9729];   //[geant_list_size]
   Float_t         pathlen[9729];   //[geant_list_size]
   Int_t           inTPCActive[9729];   //[geant_list_size]
   Float_t         StartPointx_tpcAV[9729];   //[geant_list_size]
   Float_t         StartPointy_tpcAV[9729];   //[geant_list_size]
   Float_t         StartPointz_tpcAV[9729];   //[geant_list_size]
   Float_t         StartT_tpcAV[9729];   //[geant_list_size]
   Float_t         StartE_tpcAV[9729];   //[geant_list_size]
   Float_t         StartP_tpcAV[9729];   //[geant_list_size]
   Float_t         StartPx_tpcAV[9729];   //[geant_list_size]
   Float_t         StartPy_tpcAV[9729];   //[geant_list_size]
   Float_t         StartPz_tpcAV[9729];   //[geant_list_size]
   Float_t         EndPointx_tpcAV[9729];   //[geant_list_size]
   Float_t         EndPointy_tpcAV[9729];   //[geant_list_size]
   Float_t         EndPointz_tpcAV[9729];   //[geant_list_size]
   Float_t         EndT_tpcAV[9729];   //[geant_list_size]
   Float_t         EndE_tpcAV[9729];   //[geant_list_size]
   Float_t         EndP_tpcAV[9729];   //[geant_list_size]
   Float_t         EndPx_tpcAV[9729];   //[geant_list_size]
   Float_t         EndPy_tpcAV[9729];   //[geant_list_size]
   Float_t         EndPz_tpcAV[9729];   //[geant_list_size]
   Float_t         pathlen_drifted[9729];   //[geant_list_size]
   Int_t           inTPCDrifted[9729];   //[geant_list_size]
   Float_t         StartPointx_drifted[9729];   //[geant_list_size]
   Float_t         StartPointy_drifted[9729];   //[geant_list_size]
   Float_t         StartPointz_drifted[9729];   //[geant_list_size]
   Float_t         StartT_drifted[9729];   //[geant_list_size]
   Float_t         StartE_drifted[9729];   //[geant_list_size]
   Float_t         StartP_drifted[9729];   //[geant_list_size]
   Float_t         StartPx_drifted[9729];   //[geant_list_size]
   Float_t         StartPy_drifted[9729];   //[geant_list_size]
   Float_t         StartPz_drifted[9729];   //[geant_list_size]
   Float_t         EndPointx_drifted[9729];   //[geant_list_size]
   Float_t         EndPointy_drifted[9729];   //[geant_list_size]
   Float_t         EndPointz_drifted[9729];   //[geant_list_size]
   Float_t         EndT_drifted[9729];   //[geant_list_size]
   Float_t         EndE_drifted[9729];   //[geant_list_size]
   Float_t         EndP_drifted[9729];   //[geant_list_size]
   Float_t         EndPx_drifted[9729];   //[geant_list_size]
   Float_t         EndPy_drifted[9729];   //[geant_list_size]
   Float_t         EndPz_drifted[9729];   //[geant_list_size]
   Int_t           NumberDaughters[9729];   //[geant_list_size]
   Int_t           Mother[9729];   //[geant_list_size]
   Int_t           TrackId[9729];   //[geant_list_size]
   Int_t           MergedId[9729];   //[geant_list_size]
   Int_t           origin[9729];   //[geant_list_size]
   Int_t           MCTruthIndex[9729];   //[geant_list_size]
   Int_t           process_primary[9729];   //[geant_list_size]
   vector<string>  *processname;
   Int_t           no_mctracks;
   Int_t           mctrk_origin[781];   //[no_mctracks]
   Int_t           mctrk_pdg[781];   //[no_mctracks]
   Int_t           mctrk_TrackId[781];   //[no_mctracks]
   vector<string>  *mctrk_Process;
   Float_t         mctrk_startX[781];   //[no_mctracks]
   Float_t         mctrk_startY[781];   //[no_mctracks]
   Float_t         mctrk_startZ[781];   //[no_mctracks]
   Float_t         mctrk_endX[781];   //[no_mctracks]
   Float_t         mctrk_endY[781];   //[no_mctracks]
   Float_t         mctrk_endZ[781];   //[no_mctracks]
   Float_t         mctrk_startX_drifted[781];   //[no_mctracks]
   Float_t         mctrk_startY_drifted[781];   //[no_mctracks]
   Float_t         mctrk_startZ_drifted[781];   //[no_mctracks]
   Float_t         mctrk_endX_drifted[781];   //[no_mctracks]
   Float_t         mctrk_endY_drifted[781];   //[no_mctracks]
   Float_t         mctrk_endZ_drifted[781];   //[no_mctracks]
   Float_t         mctrk_len_drifted[781];   //[no_mctracks]
   Float_t         mctrk_p_drifted[781];   //[no_mctracks]
   Float_t         mctrk_px_drifted[781];   //[no_mctracks]
   Float_t         mctrk_py_drifted[781];   //[no_mctracks]
   Float_t         mctrk_pz_drifted[781];   //[no_mctracks]
   Int_t           nmctrksteps[781];   //[no_mctracks]
   Float_t         mctrk_dEdx[781][2000];   //[no_mctracks]
   Int_t           mctrk_Motherpdg[781];   //[no_mctracks]
   Int_t           mctrk_MotherTrkId[781];   //[no_mctracks]
   vector<string>  *mctrk_MotherProcess;
   Float_t         mctrk_MotherstartX[781];   //[no_mctracks]
   Float_t         mctrk_MotherstartY[781];   //[no_mctracks]
   Float_t         mctrk_MotherstartZ[781];   //[no_mctracks]
   Float_t         mctrk_MotherendX[781];   //[no_mctracks]
   Float_t         mctrk_MotherendY[781];   //[no_mctracks]
   Float_t         mctrk_MotherendZ[781];   //[no_mctracks]
   Int_t           mctrk_Ancestorpdg[781];   //[no_mctracks]
   Int_t           mctrk_AncesotorTrkId[781];   //[no_mctracks]
   vector<string>  *mctrk_AncesotorProcess;
   Float_t         mctrk_AncestorstartX[781];   //[no_mctracks]
   Float_t         mctrk_AncestorstartY[781];   //[no_mctracks]
   Float_t         mctrk_AncestorstartZ[781];   //[no_mctracks]
   Float_t         mctrk_AncestorendX[781];   //[no_mctracks]
   Float_t         mctrk_AncestorendY[781];   //[no_mctracks]
   Float_t         mctrk_AncestorendZ[781];   //[no_mctracks]
   Short_t         nshowers_emshower;
   Short_t         showerID_emshower[201];   //[nshowers_emshower]
   Short_t         shwr_bestplane_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_length_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_startdcosx_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_startdcosy_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_startdcosz_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_startx_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_starty_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_startz_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_totEng_emshower[201][3];   //[nshowers_emshower]
   Float_t         shwr_dedx_emshower[201][3];   //[nshowers_emshower]
   Float_t         shwr_mipEng_emshower[201][3];   //[nshowers_emshower]
   Short_t         shwr_hasPFParticle_emshower[201];   //[nshowers_emshower]
   Short_t         shwr_PFParticleID_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_pidmvamu_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_pidmvae_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_pidmvapich_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_pidmvaphoton_emshower[201];   //[nshowers_emshower]
   Float_t         shwr_pidmvapr_emshower[201];   //[nshowers_emshower]
   Short_t         ntracks_pmtrack;
   Short_t         trkId_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_tagger_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_tagger_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_tagger_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_containmenttagger_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_containmenttagger_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_containmenttagger_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_flashmatch_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_flashmatch_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_flashmatch_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkke_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkrange_pmtrack[176][3];   //[ntracks_pmtrack]
   Int_t           trkidtruth_pmtrack[176][3];   //[ntracks_pmtrack]
   Short_t         trkorigin_pmtrack[176][3];   //[ntracks_pmtrack]
   Int_t           trkpdgtruth_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkefftruth_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpurtruth_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpitchc_pmtrack[176][3];   //[ntracks_pmtrack]
   Short_t         ntrkhits_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkdedx_pmtrack[176][3][2000];   //[ntracks_pmtrack]
   Float_t         trkdqdx_pmtrack[176][3][2000];   //[ntracks_pmtrack]
   Float_t         trkresrg_pmtrack[176][3][2000];   //[ntracks_pmtrack]
   Int_t           trktpc_pmtrack[176][3][2000];   //[ntracks_pmtrack]
   Float_t         trkxyz_pmtrack[176][3][2000][3];   //[ntracks_pmtrack]
   Float_t         trkstartx_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkstarty_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkstartz_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkstartd_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkendx_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkendy_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkendz_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkendd_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkflashT0_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trktrueT0_pmtrack[176];   //[ntracks_pmtrack]
   Int_t           trkg4id_pmtrack[176];   //[ntracks_pmtrack]
   Int_t           trkorig_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkpurity_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkcompleteness_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trktheta_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkphi_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkstartdcosx_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkstartdcosy_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkstartdcosz_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkenddcosx_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkenddcosy_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkenddcosz_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkthetaxz_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkthetayz_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkmom_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkmomrange_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkmommschi2_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkmommsllhd_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trklen_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trksvtxid_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkevtxid_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkpidmvamu_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkpidmvae_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkpidmvapich_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkpidmvaphoton_pmtrack[176];   //[ntracks_pmtrack]
   Float_t         trkpidmvapr_pmtrack[176];   //[ntracks_pmtrack]
   Int_t           trkpidpdg_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpidchi_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipr_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpidchika_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipi_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpidchimu_pmtrack[176][3];   //[ntracks_pmtrack]
   Float_t         trkpidpida_pmtrack[176][3];   //[ntracks_pmtrack]
   Short_t         trkpidbestplane_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkhasPFParticle_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         trkPFParticleID_pmtrack[176];   //[ntracks_pmtrack]
   Short_t         ntracks_pmtracktc;
   Short_t         trkId_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_tagger_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_tagger_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_tagger_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_containmenttagger_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_containmenttagger_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_containmenttagger_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_flashmatch_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_flashmatch_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_flashmatch_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkke_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkrange_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Int_t           trkidtruth_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Short_t         trkorigin_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Int_t           trkpdgtruth_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkefftruth_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpurtruth_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpitchc_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Short_t         ntrkhits_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkdedx_pmtracktc[237][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkdqdx_pmtracktc[237][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkresrg_pmtracktc[237][3][2000];   //[ntracks_pmtracktc]
   Int_t           trktpc_pmtracktc[237][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkxyz_pmtracktc[237][3][2000][3];   //[ntracks_pmtracktc]
   Float_t         trkstartx_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkstarty_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkstartz_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkstartd_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkendx_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkendy_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkendz_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkendd_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkflashT0_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trktrueT0_pmtracktc[237];   //[ntracks_pmtracktc]
   Int_t           trkg4id_pmtracktc[237];   //[ntracks_pmtracktc]
   Int_t           trkorig_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkpurity_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkcompleteness_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trktheta_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkphi_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosx_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosy_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosz_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkenddcosx_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkenddcosy_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkenddcosz_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkthetaxz_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkthetayz_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkmom_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkmomrange_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkmommschi2_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkmommsllhd_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trklen_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trksvtxid_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkevtxid_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkpidmvamu_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkpidmvae_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkpidmvapich_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkpidmvaphoton_pmtracktc[237];   //[ntracks_pmtracktc]
   Float_t         trkpidmvapr_pmtracktc[237];   //[ntracks_pmtracktc]
   Int_t           trkpidpdg_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchi_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchipr_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchika_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchipi_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchimu_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Float_t         trkpidpida_pmtracktc[237][3];   //[ntracks_pmtracktc]
   Short_t         trkpidbestplane_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkhasPFParticle_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         trkPFParticleID_pmtracktc[237];   //[ntracks_pmtracktc]
   Short_t         ntracks_pandoraTrack;
   Short_t         trkId_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_tagger_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_tagger_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_tagger_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_containmenttagger_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_containmenttagger_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_containmenttagger_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_flashmatch_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_flashmatch_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_flashmatch_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkke_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkrange_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Int_t           trkidtruth_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Short_t         trkorigin_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Int_t           trkpdgtruth_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkefftruth_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpurtruth_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpitchc_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Short_t         ntrkhits_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkdedx_pandoraTrack[173][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkdqdx_pandoraTrack[173][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkresrg_pandoraTrack[173][3][2000];   //[ntracks_pandoraTrack]
   Int_t           trktpc_pandoraTrack[173][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkxyz_pandoraTrack[173][3][2000][3];   //[ntracks_pandoraTrack]
   Float_t         trkstartx_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkstarty_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkstartz_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkstartd_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkendx_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkendy_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkendz_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkendd_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkflashT0_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trktrueT0_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Int_t           trkg4id_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Int_t           trkorig_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkpurity_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkcompleteness_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trktheta_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkphi_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosx_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosy_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosz_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosx_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosy_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosz_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkthetaxz_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkthetayz_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkmom_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkmomrange_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkmommschi2_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkmommsllhd_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trklen_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trksvtxid_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkevtxid_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvamu_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvae_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvapich_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvaphoton_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvapr_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Int_t           trkpidpdg_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchi_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchipr_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchika_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchipi_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchimu_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidpida_pandoraTrack[173][3];   //[ntracks_pandoraTrack]
   Short_t         trkpidbestplane_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkhasPFParticle_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         trkPFParticleID_pandoraTrack[173];   //[ntracks_pandoraTrack]
   Short_t         ntracks_pmtrajfit;
   Short_t         trkId_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_tagger_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_tagger_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_tagger_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_containmenttagger_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_containmenttagger_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_containmenttagger_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_flashmatch_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_flashmatch_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_flashmatch_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkke_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkrange_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Int_t           trkidtruth_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Short_t         trkorigin_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Int_t           trkpdgtruth_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkefftruth_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpurtruth_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpitchc_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Short_t         ntrkhits_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkdedx_pmtrajfit[283][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkdqdx_pmtrajfit[283][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkresrg_pmtrajfit[283][3][2000];   //[ntracks_pmtrajfit]
   Int_t           trktpc_pmtrajfit[283][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkxyz_pmtrajfit[283][3][2000][3];   //[ntracks_pmtrajfit]
   Float_t         trkstartx_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkstarty_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkstartz_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkstartd_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkendx_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkendy_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkendz_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkendd_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkflashT0_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trktrueT0_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Int_t           trkg4id_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Int_t           trkorig_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkpurity_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkcompleteness_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trktheta_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkphi_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosx_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosy_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosz_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosx_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosy_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosz_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkthetaxz_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkthetayz_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkmom_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkmomrange_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkmommschi2_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkmommsllhd_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trklen_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trksvtxid_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkevtxid_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvamu_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvae_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvapich_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvaphoton_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvapr_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Int_t           trkpidpdg_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchi_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchipr_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchika_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchipi_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchimu_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidpida_pmtrajfit[283][3];   //[ntracks_pmtrajfit]
   Short_t         trkpidbestplane_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkhasPFParticle_pmtrajfit[283];   //[ntracks_pmtrajfit]
   Short_t         trkPFParticleID_pmtrajfit[283];   //[ntracks_pmtrajfit]
   ...
   Short_t         vtxId_pmtrack[161];   //[nvtx_pmtrack]
   Float_t         vtxx_pmtrack[161];   //[nvtx_pmtrack]
   Float_t         vtxy_pmtrack[161];   //[nvtx_pmtrack]
   Float_t         vtxz_pmtrack[161];   //[nvtx_pmtrack]
   Short_t         vtxhasPFParticle_pmtrack[161];   //[nvtx_pmtrack]
   Short_t         vtxPFParticleID_pmtrack[161];   //[nvtx_pmtrack]
   Short_t         nvtx_pandora;
   Short_t         vtxId_pandora[281];   //[nvtx_pandora]
   Float_t         vtxx_pandora[281];   //[nvtx_pandora]
   Float_t         vtxy_pandora[281];   //[nvtx_pandora]
   Float_t         vtxz_pandora[281];   //[nvtx_pandora]
   Short_t         vtxhasPFParticle_pandora[281];   //[nvtx_pandora]
   Short_t         vtxPFParticleID_pandora[281];   //[nvtx_pandora]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../files/mcreco_ana_hist.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../files/mcreco_ana_hist.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../../files/mcreco_ana_hist.root:/analysistree");
