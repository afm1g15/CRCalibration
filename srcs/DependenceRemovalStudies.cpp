/************************************************************************
 * 
 * A macro to understand the dependence of the muon's energy dependence
 * on various quantities for the purpose of tuning the CR muon 
...
int dependenceRemovalStudies(const char *config){
